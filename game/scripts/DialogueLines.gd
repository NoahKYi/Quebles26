...
const LINES := {
	...
	"found_clue_2_after_daughter_asked": "Well, this will lists both the son and daughter as beneficiares, both of them had a motive to commit the murder",
	"found_clue_3": "This journal shows the daughter planning the murder. I'm going to go ask her to explain this.",
